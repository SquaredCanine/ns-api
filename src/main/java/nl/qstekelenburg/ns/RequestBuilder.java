...
import nl.qstekelenburg.ns.model.storingen.Storingen;
...
public class RequestBuilder {
     ...
     */
    public static ApiRequest<VervoerderKeuzes> getPrijzen(String fromStation, String toStation) {
     ...
     * @return Request for getting the fares
     */
    public static ApiRequest<VervoerderKeuzes> getPrijzen(String fromStation, String toStation, String dateTime) {
     ...
     * @return Request for getting the fares
     */
    public static ApiRequest<VervoerderKeuzes> getPrijzen(String fromStation, String toStation, String viaStation,
                                                          String dateTime) {
